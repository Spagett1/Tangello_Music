            ...
            egui::menu::bar(ui, |ui| {
                ui.vertical(|ui| {
                    ui.with_layout(Layout::left_to_right(), |ui| {
                            ...
                            _ => {
                                ...
                                ui.vertical(|ui|{
                                    ...
                                    ui.horizontal(|ui|{
                                        ...
                                        ui.add_space(2. * self.config.scale);
                        ...
                        // ui.with_layout(egui::Layout::bottom_up(emath::Align::Center), |ui|{
                        ...
                        //     if ui.add(Button::new(RichText::new('玲').text_style(if window_width < 730. {heading3()} else {egui::TextStyle::Heading}))
                        //         .frame(false)).clicked() {
                        //         conn.prev().unwrap_or(());
                        //         Tangello::song_change(self, conn);
                        //     }
                        ...
                        //         State::Play => "",
                        //         _ => "",
                        //         }).text_style(if window_width < 730. {heading3()} else {egui::TextStyle::Heading}))
                        //         .frame(false)).clicked() 
                        //     {
                        //         match conn.status().expect("Could not get the mpd state.").state {
                        //             State::Play => {
                        ...
                        //     if ui.add(Button::new(RichText::new('怜').text_style(if window_width < 730. {heading3()} else {egui::TextStyle::Heading}))
                        //         .frame(false)).clicked() {
                        //         conn.next().unwrap_or(());
                        //         Tangello::song_change(self, conn);
                        //     }                           
